...
export default function EditContention({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ returnUrl?: string }> }) {
  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center gap-4 mb-8"><Link href={returnUrl || "/admin/contentions"} className="p-2 hover:bg-muted/10 rounded-lg"><ArrowLeft size={20} className="text-muted" /></Link><h1 className="text-3xl font-bold font-serif text-foreground">Edit Contention</h1></div>
